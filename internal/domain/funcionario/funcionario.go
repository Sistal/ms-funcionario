...
type Funcionario struct {
	...
	Cargo    *Cargo              `json:"cargo,omitempty" gorm:"foreignKey:IDCargo;references:IDCargo"`
	Sucursal *Sucursal           `json:"sucursal,omitempty" gorm:"foreignKey:IDSucursal;references:IDSucursal"`
	Medidas  *MedidasFuncionario `json:"medidas,omitempty" gorm:"foreignKey:IDMedidas;references:IDMedidas"`
	Genero   *Genero             `json:"genero,omitempty" gorm:"foreignKey:IDGenero;references:IDGenero"`
	Estado   *Estado             `json:"estado,omitempty" gorm:"foreignKey:IDEstado;references:IDEstado"`
}
